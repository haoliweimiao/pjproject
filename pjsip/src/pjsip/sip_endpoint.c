 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_register_module(pjsip_endpoint *endpt,
                            pjsip_module *mod)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_unregister_module(pjsip_endpoint *endpt,
                              pjsip_module *mod)
{
    pj_status_t status;
...
pjsip_endpt_get_capability(pjsip_endpoint *endpt,
                           int htype,
 ...
 */
PJ_DEF(pj_bool_t)
pjsip_endpt_has_capability(pjsip_endpoint *endpt,
                           int htype,
                           const pj_str_t *hname,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_add_capability(pjsip_endpoint *endpt,
                           pjsip_module *mod,
                           int htype,
                           const pj_str_t *hname,
                           unsigned count,
 ...
 */
PJ_DEF(const pjsip_hdr *)
pjsip_endpt_get_request_headers(pjsip_endpoint *endpt)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create(pj_pool_factory *pf,
                   const char *name,
 ...
 */
PJ_DEF(void)
pjsip_endpt_destroy(pjsip_endpoint *endpt)
{
    pjsip_module *mod;
    exit_cb *ecb;
...
pjsip_endpt_name(const pjsip_endpoint *endpt)
{
    return &endpt->name;
}
 ...
 */
PJ_DEF(pj_pool_t *)
pjsip_endpt_create_pool(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(void)
pjsip_endpt_release_pool(pjsip_endpoint *endpt, pj_pool_t *pool)
{
...
#if PJ_TIMER_DEBUG
PJ_DEF(pj_status_t)
pjsip_endpt_schedule_timer_dbg(pjsip_endpoint *endpt,
...
#else
PJ_DEF(pj_status_t)
pjsip_endpt_schedule_timer(pjsip_endpoint *endpt,
                           pj_timer_entry *entry,
                           const pj_time_val *delay)
{
    PJ_LOG(6, (THIS_FILE, "pjsip_endpt_schedule_timer(entry=%p, delay=%u.%u)",
...
#if PJ_TIMER_DEBUG
PJ_DEF(pj_status_t)
pjsip_endpt_schedule_timer_w_grp_lock_dbg(
    pjsip_endpoint *endpt,
    pj_timer_entry *entry,
    const pj_time_val *delay,
    int id_val,
 ...
 */
PJ_DEF(void)
pjsip_endpt_cancel_timer(pjsip_endpoint *endpt,
                         pj_timer_entry *entry)
{
...
/* Distribute rdata */
PJ_DEF(pj_status_t)
pjsip_endpt_process_rx_data(pjsip_endpoint *endpt,
                            pjsip_rx_data *rdata,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create_tdata(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create_resolver(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_set_resolver(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_dns_resolver *)
pjsip_endpt_get_resolver(pjsip_endpoint *endpt)
{
 ...
 */
PJ_DEF(void)
pjsip_endpt_resolve(pjsip_endpoint *endpt,
                    pj_pool_t *pool,
 ...
 */
PJ_DEF(pjsip_tpmgr *)
pjsip_endpt_get_tpmgr(pjsip_endpoint *endpt)
{
 ...
 */
PJ_DEF(pj_ioqueue_t *)
pjsip_endpt_get_ioqueue(pjsip_endpoint *endpt)
{
 ...
 */
PJ_DEF(void)
pjsip_endpt_log_error(pjsip_endpoint *endpt,
                      const char *sender,
...
PJ_DEF(pj_status_t)
pjsip_endpt_atexit(pjsip_endpoint *endpt,
                   pjsip_endpt_exit_callback func)
{
    exit_cb *new_cb;
